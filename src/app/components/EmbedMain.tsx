...
export default function EmbedMain({ ownerId }: { ownerId: string }) {
    const navigate = useRouter()
    const [copied, SetCopied] = useState(false)
    const embedCode = `
    <script 
        src="${process.env.NEXT_PUBLIC_LOCAL_URL}/chatBot.js"
        ...
        <div className='min-h-screen bg-zinc-50 text-zinc-900'>
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200 '>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between' >
                    <div className='text-lg font-semibold cursor-pointer'> ChatBot <span className='text-zinc-400'>AI</span></div>
            ...
            <div className='flex justify-center px-4 py-14'>
                ...
                >
                    <h1 className='text-2xl font-semibold mb-2'> Embed ChatBot.Ai </h1>
                    ...
                    <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10'>
                        ...
                        <button className='absolute top-3 right-3 bg-white text-zinc-900 
                        text-xs font-medium px-3 py-1.5 rounded-lg hover:bg-zinc-200 transition'
                            onClick={copyCode}>
                    ...
                    <div className='mt-14'>
                        ...
                        <p className='text-sm text-zinc-400 mb-6'> This is how the chatbot will apper or your website. </p>
                        <div className='rounded-xl border border-zinc-600 bg-white shadow-md overflow-hidden'>
                            ...
                            <div className='relative h-64 sm:h-72 p-6 text-zinc-400 text-sm'>
                                ...
                                <div className='absolute bottom-24 right-6 w-64 bg-white rounded-xl shadow-xl border border-zinc-200 overflow-hidden'>
                                    ...
                                    <div className='p-3 space-y-2 bg-zinc-50'>
                                        <div className='bg-zinc-200 text-zinc-800 text-xs px-3  py-2
                                        rounded-lg w-fit'>Hii !How can i help you?</div>
                                        <div className='bg-black text-white text-xs px-3  py-2
                                        rounded-lg ml-auto w-fit'>what  is return policy? </div>
                                    </div>
                                </div>
